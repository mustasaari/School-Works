...
class E16 {
        ...
        static int level = 1;
        static boolean levelReset = false;
    ...
    public static String [][] pelaajanPaikka(String [][] a, int b, int c) {
        ...
        if (playerx == exitx +1 && playery == exity +1 && exitOpen == true){
    ...
    public static void getInput() {         //pelaajan liikkuminen
        if (endi == false && levelReset == false) {
        int contrl = 0;
    ...
    public static String[][] nextLevel(String [][] a) {
        System.out.println("WAY TO THE NEXT LEVEL");
            ...
            do {
                exitx = getRandom(1 , leveys);
                exity = getRandom(1 , korkeus);
                exity--;
                exitx--;
                System.out.println("randomx : " +exitx +"randomy : " +exity);
